...
void setLevel2(Game *gm, Level *lev)
{
	...
	gm->box[4].center.y = 0;		
        ...
        gm->plat[0].width = 0;
        gm->plat[0].height = 0;
        gm->plat[0].center.x = 0;
        gm->plat[0].center.y = 0;
...
void drawLevel2(Game *gm, Level *lev)
{
	...
	//test platforms
        ...
        gm->plat[1].width = 0;
        gm->plat[1].height = 0;
        gm->plat[1].center.x = 0;
        gm->plat[1].center.y = 0;
        //test platforms
        gm->plat[2].width = 0;
        gm->plat[2].height = 0;
        gm->plat[2].center.x = 0;
        gm->plat[2].center.y = 0;
        //test platforms
        gm->plat[3].width = 0;
        gm->plat[3].height = 0;
        gm->plat[3].center.x = 0;
        gm->plat[3].center.y = 0;
